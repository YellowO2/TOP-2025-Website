...
function About() {
    return (
        <div className='flex flex-col w-full items-center justify-center'>
            <Introduction />
            <div className="flex w-full px-8 items-center justify-center pb-32">
                <div className="border border-white/20 rounded-xl grid grid-cols-1 md:grid-cols-2 md:w-2/3 w-full">

                    <div className='flex items-center md:border-r border-b border-white/20 flex-row w-full font-medium text-2xl md:text-4xl justify-center p-8 col-span-1'>
                        What to Expect.
                    </div>

                    <div className='flex items-center border-b border-white/20 flex-row justify-center gap-4 w-full p-8 col-span-1'>
                    ...
                    <div className='flex items-center border-b md:border-b-0 md:border-r border-white/20 flex-row justify-center gap-4 w-full p-8 col-span-1'>
                    ...
                    <div className='flex items-center flex-row justify-center gap-4 w-full p-8 col-span-1'>
                    ...
                    <div className='flex items-center border-t border-white/20 col-span-1 md:col-span-2 row-span-1 flex-row justify-center gap-4 w-full p-8'>
