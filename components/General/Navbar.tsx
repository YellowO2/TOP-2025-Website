        ...
        <div className='relative'>
            ...
            <div className='lg:hidden w-screen flex fixed top-0 left-0 right-0 z-30 h-12'>
                <div className='flex items-center justify-center w-full h-full mx-4 mt-4'>
                    <div className='flex items-center justify-between gap-4 w-full h-full navMenuContainer pr-2 pl-2'>
            ...
            <div className={`lg:hidden fixed w-screen top-0 left-0 h-screen bg-black bg-repeat-y z-[25] pt-24 px-8 ${menuOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'} transition-opacity duration-300 ease-in-out`}>
                <div className='flex flex-col gap-4'>
                    <Link href='/' className='flex uppercase tracking-widest' onClick={handleLinkClick}>Home</Link>
                    <div className='menuDivider' />
                    <Link href='/about' className='flex uppercase tracking-widest' onClick={handleLinkClick}>About Us</Link>
                    <div className='menuDivider' />
                    <Link href='/games' className='flex uppercase tracking-widest' onClick={handleLinkClick}>Games</Link>
                    <div className='menuDivider' />
                    <Link href='/schedule' className='flex uppercase tracking-widest' onClick={handleLinkClick}>Schedule</Link>
                    <div className='menuDivider' />
